package com.xircle.postservice.presentation.controller

import com.xircle.common.response.BaseResponse
import com.xircle.common.response.BaseResponseStatus
import com.xircle.postservice.application.service.PostService
...
class PostController(private val postService: PostService) {
    ...
    fun getPostByMemberProfile(
        ...
        val response = postService.getProfilePostByMember(page, size, memberId, hashtag).stream()
            .map { post ->
